''' An example that solves the flow around a circle. The purpose of this example is to investigate the turbulence behind a turbine. ''' 
...
def default_config():
  ...
  config = sw_config.DefaultConfiguration(mesh_file = 'mesh.xml')
