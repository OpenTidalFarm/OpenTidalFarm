...
#
#
# power_reduced_functional
# =======================
#
# formulates the reduced functional object for power
#
#
#
...
class ReducedFunctionalNumPy(dolfin_adjoint.ReducedFunctionalNumPy):
    ...
    def __init__(self, config, scale = 1.0, model,
                 save_functional_values = False):
        ''' Implements a reduced functional object for the 'power' objective
