...
class ApproximateShallowWater(Model):
    ...
    def __init__(self, flow_field, turbine_radius, model_parameters=None):
        ...
        mesh = dolfin.RectangleMesh(-200, -500, 1500, 500, 100, 100)
        ...
        wake = out_state.split()[0]
        self.wake = ADDolfinExpression(wake)
    ...
    def wake_radius(self, x0):
        """
        Value is from looking at the wake in paraview
        """
        return 450.
