...
problem.parameters.tidal_farm.update()
...
turbine_positions = solver.problem.parameters.tidal_farm.turbine_positions
#flattened_turbine_positions = np.array(turbine_positions).flatten()
fitness_function = fitness_function(numpy.array(turbine_positions))

print 'END OF THE SHOW', fitness_function
...
#optimiser_parameters["population_options"]["upper_limits"] = (480., 240.)
#optimiser_parameters["population_options"]["lower_limits"] = (160., 240.)
#
