...
# set some parameters for basinhoppings local minimizer
minimizer_kwargs = {"method": "L-BFGS-B", "bounds": [lb, ub],\
                    "options": {"disp": True}}

# optimize using basinhopping
maximize(rf, method = "basinhopping", \
         stepsize=50, # sets initial size for a random hop
         interval=5,  # sets the interval to update the stepsize
         niter=200,   # maximum number of basin hops to take
